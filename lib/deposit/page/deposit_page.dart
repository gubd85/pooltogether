          ...
          children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          LoadingAnimationWidget.twistingDots(
                            leftDotColor:
                                const Color.fromRGBO(255, 119, 225, 1),
                            rightDotColor:
                                const Color.fromRGBO(255, 237, 71, 1),
                            size: 30,
                          ),
                          const SizedBox(
                            width: 10,
                          ...
                          LoadingAnimationWidget.twistingDots(
                            ...
                            rightDotColor:
                                const Color.fromRGBO(23, 225, 253, 1),
                            size: 30,
                          )
                        ],
                      ),
                      ...
                      decoration: InputDecoration(
                        focusedBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: Color.fromRGBO(65, 48, 103, 1),
                              width: 2.0),
                        ),
                        hintText: '0.0',
            ...
            Container(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () async {
                    await launch(
                        "https://metamask.app.link/dapp/pooltogether.page.link/start");
